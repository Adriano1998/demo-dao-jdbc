...
public class Vendedor implements Serializable {
	...
	public Vendedor(Integer id, String nome, String email, Date data_aniver, Double salario,
	...
	public String toString() {
		return "Vendedor [id=" + id + ", nome=" + nome + ", email=" + email + ", data_aniver=" + data_aniver
